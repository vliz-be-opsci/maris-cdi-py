...
NAME = 'maris_cdi'
DESCRIPTION = 'py library to retrieve ODV datasets from the maris CDI service (api)'
URL = 'https://github.com/vliz-be-opsci/maris-cdi-py'
EMAIL = 'marc.portier@gmail.com'
AUTHOR = 'Marc Portier'
LICENSE = 'MIT'
CONSOLE_SCRIPTS = ['maris_cdi = maris_cdi.__main__:main']
TROVE_CLASSES = [
    # Trove classifiers
